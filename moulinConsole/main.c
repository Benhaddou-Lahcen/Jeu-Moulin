...
typedef struct {
    ...
    unsigned int jetonGagne1 : 4;
    unsigned int jetonGagne2 : 4;
...
Position* ouRetirerJeton1(Etat* etat) {
    ...
    positions = realloc(positions, (nb_positions+1) * sizeof(Position));
...
void MachineVsJoueur1() {
    ...
    while (1) {
        ...
        resultat = Alphabeta(noeudInitial, profondeur, a, b, 0,&nombreDeNoeuds);
        printf("Nombre de noeuds generes par alphabeta : %d\n", nombreDeNoeuds);
        printf("Coup de l'ordinateur Alphabeta:\n");
        affichage(resultat->etat.matrice);
        resultat1 = Minimax(noeudInitial, profondeur, 0, &nombreDeNoeuds1);
...
void MachineVsJoueur2() {
    ...
    while (1) {
        int nombreDeNoeuds = 0;
        int nombreDeNoeuds1 = 0;
        resultat = Alphabeta(noeudInitial, profondeur, a, b, 1,&nombreDeNoeuds);
        printf("Nombre de noeuds generes par alphabeta : %d\n", nombreDeNoeuds);
        printf("Coup de l'ordinateur Alphabeta:\n");
        affichage(resultat->etat.matrice);
        resultat1 = Minimax(noeudInitial, profondeur, 1, &nombreDeNoeuds1);
        printf("Nombre de noeuds generes par minmax: %d\n", nombreDeNoeuds1);
        printf("Coup de l'ordinateur minmax:\n");
        affichage(resultat1->etat.matrice);
        // Vérification de l'état du jeu après le coup de l'ordinateur
...
int main() {
    ...
    do {
        printf("Menu :\n");
        printf("1. Machine Vs Joueur 1\n");
        printf("2. Machine Vs Joueur 2\n");
